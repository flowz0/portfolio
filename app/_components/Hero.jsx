...
export default function Hero() {
    return (
        <header id="about" className="h-screen flex flex-col items-center justify-center bg-neutral-800 text-neutral-50">
            <h2 className="text-sm font-light tracking-widest text-sky-500">Portfolio</h2>
            <h1 className="text-4xl font-bold tracking-wide mt-6 md:text-6xl">Billy Flowers</h1>
            <div className="tracking-wider mt-4 text-neutral-400 md:text-lg">
                I'm a {" "}
